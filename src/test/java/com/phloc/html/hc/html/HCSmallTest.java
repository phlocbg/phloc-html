...
public final class HCSmallTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCSmall.create ((IPredefinedLocaleTextProvider) null, (IPredefinedLocaleTextProvider) null).getChildCount ());
    ...
    assertEquals (0, HCSmall.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCSmall.create (ContainerHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                         .getChildCount ());
