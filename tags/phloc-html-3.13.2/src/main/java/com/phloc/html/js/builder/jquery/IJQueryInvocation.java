 ...
 * @author com.phloc.html.supplementary.jquery.Main_IJQueryInvocation
*/
public interface IJQueryInvocation <IMPLTYPE extends IJQueryInvocation <IMPLTYPE>>
{
  ...
  * Certain versions of this method are deprecated since jQuery 1.7
  ...
  /**
   * @return The invocation of the jQuery function <code>height()</code> with return type Integer or jQuery
   */
  @Nonnull
  IMPLTYPE height ();
  ...
  /**
   * @return The invocation of the jQuery function <code>innerHeight()</code> with return type Integer
   * @since jQuery 1.2.6
   */
  @Nonnull
  ...
  /**
   * @return The invocation of the jQuery function <code>innerWidth()</code> with return type Integer
   * @since jQuery 1.2.6
   */
  @Nonnull
  IMPLTYPE innerWidth ();
  ...
  * Certain versions of this method are deprecated since jQuery 1.8
  ...
  /**
   * @return The invocation of the jQuery function <code>outerHeight()</code> with return type Integer
   */
  @Nonnull
  IMPLTYPE outerHeight ();

  /**
   * @return The invocation of the jQuery function <code>outerWidth()</code> with return type Integer
   */
  @Nonnull
  IMPLTYPE outerWidth ();
  ...
  * Certain versions of this method are deprecated since jQuery 1.8
  ...
  /**
   * @return The invocation of the jQuery function <code>width()</code> with return type Integer or jQuery
   */
  @Nonnull
  IMPLTYPE width ();
