...
public final class XHTMLParserTest
{
  ...
  {
    assertNotNull (XHTMLParser.unescapeXHTML ("<b>Hallo</b>"));
    assertNotNull (XHTMLParser.unescapeXHTML ("<b>Hallo<br/>phloc</b>"));
    assertNull (XHTMLParser.unescapeXHTML ("<b>Hallo"));
    assertNull (XHTMLParser.unescapeXHTML ("Hallo</b>"));
    assertNull (XHTMLParser.unescapeXHTML ("&"));
  }
  ...
  public void testconvertToXHTMLOnDemand ()
  {
    ...
    aNode = XHTMLParser.convertToXHTMLOnDemand ("Hallo</b>");
    assertTrue (aNode instanceof HCTextNode);
