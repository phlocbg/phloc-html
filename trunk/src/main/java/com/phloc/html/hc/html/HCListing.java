...
/**
 * Represents an HTML &lt;LISTING&gt; element<br>
...
public class HCListing extends AbstractHCElementWithChildren <HCListing>
{
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final IPredefinedLocaleTextProvider aChild)
  {
    return new HCListing ().addChild (aChild);
  }
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final String sChild)
  {
    return new HCListing ().addChild (sChild);
  }
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final String... aChildren)
  {
    return new HCListing ().addChildren (aChildren);
  }

  /**
   * Create a new LISTING element with the passed child node
   * 
   * @param aChild
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final IHCNode aChild)
  {
    return new HCListing ().addChild (aChild);
  }

  /**
   * Create a new LISTING element with the passed child nodes
   * 
   * @param aChildren
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final IHCNode... aChildren)
  {
    return new HCListing ().addChildren (aChildren);
  }
   ...
   */
  @Nonnull
  public static HCListing create (@Nullable final Iterable <? extends IHCNode> aChildren)
  {
    return new HCListing ().addChildren (aChildren);
  }
}
