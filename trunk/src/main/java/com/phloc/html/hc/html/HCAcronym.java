...
/**
 * Represents an HTML &lt;ACRONYM&gt; element<br>
...
public class HCAcronym extends AbstractHCElementWithChildren <HCAcronym>
{
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final IPredefinedLocaleTextProvider aChild)
  {
    return new HCAcronym ().addChild (aChild);
  }
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final String sChild)
  {
    return new HCAcronym ().addChild (sChild);
  }
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final String... aChildren)
  {
    return new HCAcronym ().addChildren (aChildren);
  }

  /**
   * Create a new ACRONYM element with the passed child node
   * 
   * @param aChild
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final IHCNode aChild)
  {
    return new HCAcronym ().addChild (aChild);
  }

  /**
   * Create a new ACRONYM element with the passed child nodes
   * 
   * @param aChildren
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final IHCNode... aChildren)
  {
    return new HCAcronym ().addChildren (aChildren);
  }
   ...
   */
  @Nonnull
  public static HCAcronym create (@Nullable final Iterable <? extends IHCNode> aChildren)
  {
    return new HCAcronym ().addChildren (aChildren);
  }
}
