...
/**
 * Represents an HTML &lt;NOEMBED&gt; element<br>
...
public class HCNoEmbed extends AbstractHCElementWithChildren <HCNoEmbed>
{
  ...
  @Deprecated
  public HCNoEmbed (@Nullable final IPredefinedLocaleTextProvider aChild)
  {
    this ();
    addChild (aChild);
  }
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final IPredefinedLocaleTextProvider aChild)
  {
    return new HCNoEmbed ().addChild (aChild);
  }
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final String sChild)
  {
    return new HCNoEmbed ().addChild (sChild);
  }
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final String... aChildren)
  {
    return new HCNoEmbed ().addChildren (aChildren);
  }

  /**
   * Create a new NOEMBED element with the passed child node
   * 
   * @param aChild
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final IHCNode aChild)
  {
    return new HCNoEmbed ().addChild (aChild);
  }

  /**
   * Create a new NOEMBED element with the passed child nodes
   * 
   * @param aChildren
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final IHCNode... aChildren)
  {
    return new HCNoEmbed ().addChildren (aChildren);
  }
   ...
   */
  @Nonnull
  public static HCNoEmbed create (@Nullable final Iterable <? extends IHCNode> aChildren)
  {
    return new HCNoEmbed ().addChildren (aChildren);
  }
}
