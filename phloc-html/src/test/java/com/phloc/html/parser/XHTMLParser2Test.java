 ...
 */
public final class XHTMLParser2Test
{
  @Test
  public void testLooksLikeHTML ()
  {
    assertTrue (XHTMLParser2.looksLikeXHTML ("<abc>"));
    assertTrue (XHTMLParser2.looksLikeXHTML ("<a href='any'>"));
    assertTrue (XHTMLParser2.looksLikeXHTML (" <strong>"));
    assertTrue (XHTMLParser2.looksLikeXHTML ("<a href='any'><strong>what ever</strong></a>"));
    assertTrue (XHTMLParser2.looksLikeXHTML ("  <strong>Kolcowój chiński GOJI</strong> (Lycium chinense) \r\n"
                                             ...
                                             + "    <br/>"));
    assertFalse (XHTMLParser2.looksLikeXHTML ("a < b"));
    assertFalse (XHTMLParser2.looksLikeXHTML ("This is surely not XHTML :)"));
  }

  @Test
  public void testUnescapeXHTML ()
  {
    final XHTMLParser2 aParser = new XHTMLParser2 ();
