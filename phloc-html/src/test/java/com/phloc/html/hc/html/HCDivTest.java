...
public final class HCDivTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCDiv.create ((IPredefinedLocaleTextProvider) null, (IPredefinedLocaleTextProvider) null).getChildCount ());
    ...
    assertEquals (0, HCDiv.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCDiv.create (ContainerHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                         .getChildCount ());
