...
public final class HCUTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCU.create ((IPredefinedLocaleTextProvider) null).getChildCount ());
    assertEquals (0, HCU.create ((IPredefinedLocaleTextProvider) null, (IPredefinedLocaleTextProvider) null).getChildCount ());
    ...
    assertEquals (0, HCU.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCU.create (ContainerHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                         .getChildCount ());
