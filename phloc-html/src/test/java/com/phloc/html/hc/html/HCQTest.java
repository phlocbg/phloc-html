...
public final class HCQTest
{
  ...
  public void testCreate ()
  {
    ...
    assertEquals (0, HCQ.create ((IPredefinedLocaleTextProvider) null, (IPredefinedLocaleTextProvider) null).getChildCount ());
    ...
    assertEquals (0, HCQ.create ((IHCNode []) null).getChildCount ());
    assertEquals (2, HCQ.create (ContainerHelper.newList (HCB.create ("Bold"), HCI.create ("Italic")))
                         .getChildCount ());
