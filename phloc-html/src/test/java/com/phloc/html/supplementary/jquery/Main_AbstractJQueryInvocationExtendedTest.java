...
public class Main_AbstractJQueryInvocationExtendedTest extends AbstractCreateJQueryAPIList
{
  public static void main (final String [] args) throws Exception
  {
    ...
    final StringBuilder aFull = new StringBuilder ("package com.phloc.html.js.builder.jquery;\n" +
                                                   "\n" +
    ...
    aFull.append ("}\n");
    SimpleFileIO.writeFile (new File ("src/test/java/com/phloc/html/js/builder/jquery/AbstractJQueryInvocationExtendedTest.java"),
                            aFull.toString (),
