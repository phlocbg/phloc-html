...
*/
@Nonnull IMPLTYPE attr(@Nonnull IJSExpression attributes);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE blur(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE change(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE click(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE closest(@Nonnull EHTMLElement element);
...
* @param properties parameter value
*/
@Nonnull IMPLTYPE css(@Nonnull IJSExpression properties);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE dblclick(@Nonnull IJSExpression eventData);
...
*/
@Deprecated
@Nonnull IMPLTYPE die(@Nonnull IJSExpression events);
...
*/
@Deprecated
@Nonnull IMPLTYPE error(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE filter(@Nonnull EHTMLElement element);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE filter(@Nonnull IJSExpression jQuery_object);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE find(@Nonnull IJSExpression jQuery_object);

/**
* @param element parameter value
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE find(@Nonnull EHTMLElement element);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE focus(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE focusin(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE focusout(@Nonnull IJSExpression eventData);
...
* @param element parameter value
*/
@Nonnull IMPLTYPE index(@Nonnull EHTMLElement element);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE is(@Nonnull IJSExpression jQuery_object);

/**
* @param element parameter value
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE is(@Nonnull EHTMLElement element);
...
/**
* @param flags parameter value
* @since jQuery 1.7
*/
@Nonnull IMPLTYPE jQuery_Callbacks(@Nonnull String flags);

@Nonnull IMPLTYPE jQuery_Deferred();

/**
* @param beforeStart parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_Deferred(@Nonnull JSAnonymousFunction beforeStart);

/**
* @param url parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_ajax(@Nonnull String url);

/**
* @param url parameter value
* @param settings parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_ajax(@Nonnull String url, @Nonnull IJSExpression settings);

@Nonnull IMPLTYPE jQuery_ajax();

/**
* @param settings parameter value
*/
@Nonnull IMPLTYPE jQuery_ajax(@Nonnull IJSExpression settings);

/**
* @param dataTypes parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_ajaxPrefilter(@Nonnull String dataTypes);
...
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_ajaxPrefilter(@Nonnull String dataTypes, @Nonnull JSAnonymousFunction handler);

/**
* @param options parameter value
* @since jQuery 1.1
*/
@Nonnull IMPLTYPE jQuery_ajaxSetup(@Nonnull IJSExpression options);
...
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_ajaxTransport(@Nonnull String dataType, @Nonnull JSAnonymousFunction handler);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_contains(@Nonnull EHTMLElement container, @Nonnull EHTMLElement contained);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_contains(@Nonnull String container, @Nonnull EHTMLElement contained);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_contains(@Nonnull EHTMLElement container, @Nonnull String contained);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_contains(@Nonnull String container, @Nonnull String contained);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull EHTMLElement element, @Nonnull String key, @Nonnull IJSExpression value);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull String element, @Nonnull String key, @Nonnull IJSExpression value);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull EHTMLElement element, @Nonnull String key);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull String element, @Nonnull String key);

/**
* @param element parameter value
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull EHTMLElement element);

/**
* @param element parameter value
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_data(@Nonnull String element);

/**
* @param element parameter value
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_dequeue(@Nonnull EHTMLElement element);

/**
* @param element parameter value
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_dequeue(@Nonnull String element);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_dequeue(@Nonnull EHTMLElement element, @Nonnull String queueName);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_dequeue(@Nonnull String element, @Nonnull String queueName);

/**
* @param collection parameter value
* @param callback parameter value
*/
@Nonnull IMPLTYPE jQuery_each(@Nonnull IJSExpression collection, @Nonnull JSAnonymousFunction callback);

/**
* @param message parameter value
* @since jQuery 1.4.1
*/
@Nonnull IMPLTYPE jQuery_error(@Nonnull String message);

/**
* @param target parameter value
*/
@Nonnull IMPLTYPE jQuery_extend(@Nonnull IJSExpression target);

/**
* @param target parameter value
* @param object1 parameter value
*/
@Nonnull IMPLTYPE jQuery_extend(@Nonnull IJSExpression target, @Nonnull IJSExpression object1);

/**
* @param target parameter value
* @param object1 parameter value
* @param objectN parameter value
*/
@Nonnull IMPLTYPE jQuery_extend(@Nonnull IJSExpression target, @Nonnull IJSExpression object1, @Nonnull IJSExpression objectN);

/**
* @param deep parameter value
* @param target parameter value
* @since jQuery 1.1.4
*/
@Nonnull IMPLTYPE jQuery_extend(boolean deep, @Nonnull IJSExpression target);
...
* @since jQuery 1.1.4
*/
@Nonnull IMPLTYPE jQuery_extend(boolean deep, @Nonnull IJSExpression target, @Nonnull IJSExpression object1);
...
* @since jQuery 1.1.4
*/
@Nonnull IMPLTYPE jQuery_extend(boolean deep, @Nonnull IJSExpression target, @Nonnull IJSExpression object1, @Nonnull IJSExpression objectN);

/**
* @param object parameter value
*/
@Nonnull IMPLTYPE jQuery_fn_extend(@Nonnull IJSExpression object);

/**
* @param url parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url);

/**
* @param url parameter value
* @param data parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull IJSExpression data);

/**
* @param url parameter value
* @param data parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull String data);
...
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull IJSExpression data, @Nonnull JSAnonymousFunction success);
...
* @param success parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull String data, @Nonnull JSAnonymousFunction success);
...
* @param dataType parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull IJSExpression data, @Nonnull JSAnonymousFunction success, @Nonnull String dataType);
...
* @param dataType parameter value
*/
@Nonnull IMPLTYPE jQuery_get(@Nonnull String url, @Nonnull String data, @Nonnull JSAnonymousFunction success, @Nonnull String dataType);

/**
* @param url parameter value
*/
@Nonnull IMPLTYPE jQuery_getJSON(@Nonnull String url);

/**
* @param url parameter value
* @param data parameter value
*/
@Nonnull IMPLTYPE jQuery_getJSON(@Nonnull String url, @Nonnull IJSExpression data);
...
* @param success parameter value
*/
@Nonnull IMPLTYPE jQuery_getJSON(@Nonnull String url, @Nonnull IJSExpression data, @Nonnull JSAnonymousFunction success);

/**
* @param url parameter value
*/
@Nonnull IMPLTYPE jQuery_getScript(@Nonnull String url);

/**
* @param url parameter value
* @param success parameter value
*/
@Nonnull IMPLTYPE jQuery_getScript(@Nonnull String url, @Nonnull JSAnonymousFunction success);

/**
* @param code parameter value
* @since jQuery 1.0.4
*/
@Nonnull IMPLTYPE jQuery_globalEval(@Nonnull String code);

/**
* @param array parameter value
* @param function parameter value
*/
@Nonnull IMPLTYPE jQuery_grep(@Nonnull JSArray array, @Nonnull JSAnonymousFunction function);

/**
* @param array parameter value
* @param function parameter value
* @param invert parameter value
*/
@Nonnull IMPLTYPE jQuery_grep(@Nonnull JSArray array, @Nonnull JSAnonymousFunction function, boolean invert);

/**
* @param element parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_hasData(@Nonnull EHTMLElement element);

/**
* @param element parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_hasData(@Nonnull String element);

/**
* @param hold parameter value
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE jQuery_holdReady(boolean hold);
...
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array);

/**
* @param value parameter value
* @param array parameter value
* @param fromIndex parameter value
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array, int fromIndex);
...
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array, long fromIndex);
...
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array, @Nonnull BigInteger fromIndex);
...
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array, double fromIndex);
...
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_inArray(@Nonnull IJSExpression value, @Nonnull JSArray array, @Nonnull BigDecimal fromIndex);

/**
* @param obj parameter value
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_isArray(@Nonnull IJSExpression obj);

/**
* @param object parameter value
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_isEmptyObject(@Nonnull IJSExpression object);

/**
* @param obj parameter value
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_isFunction(@Nonnull IJSExpression obj);

/**
* @param value parameter value
* @since jQuery 1.7
*/
@Nonnull IMPLTYPE jQuery_isNumeric(@Nonnull IJSExpression value);

/**
* @param object parameter value
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_isPlainObject(@Nonnull IJSExpression object);

/**
* @param obj parameter value
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE jQuery_isWindow(@Nonnull IJSExpression obj);

/**
* @param node parameter value
* @since jQuery 1.1.4
*/
@Nonnull IMPLTYPE jQuery_isXMLDoc(@Nonnull EHTMLElement node);

/**
* @param node parameter value
* @since jQuery 1.1.4
*/
@Nonnull IMPLTYPE jQuery_isXMLDoc(@Nonnull String node);

/**
* @param obj parameter value
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_makeArray(@Nonnull IJSExpression obj);

/**
* @param array parameter value
* @param callback parameter value
*/
@Nonnull IMPLTYPE jQuery_map(@Nonnull JSArray array, @Nonnull JSAnonymousFunction callback);

/**
* @param arrayOrObject parameter value
* @param callback parameter value
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE jQuery_map(@Nonnull IJSExpression arrayOrObject, @Nonnull JSAnonymousFunction callback);

/**
* @param first parameter value
* @param second parameter value
*/
@Nonnull IMPLTYPE jQuery_merge(@Nonnull JSArray first, @Nonnull JSArray second);

@Nonnull IMPLTYPE jQuery_noConflict();

/**
* @param removeAll parameter value
*/
@Nonnull IMPLTYPE jQuery_noConflict(boolean removeAll);

@Nonnull IMPLTYPE jQuery_noop();

@Nonnull IMPLTYPE jQuery_now();

/**
* @param obj parameter value
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_param(@Nonnull JSArray obj);

/**
* @param obj parameter value
* @since jQuery 1.2
*/
@Nonnull IMPLTYPE jQuery_param(@Nonnull IJSExpression obj);

/**
* @param obj parameter value
* @param traditional parameter value
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_param(@Nonnull JSArray obj, boolean traditional);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_param(@Nonnull IJSExpression obj, boolean traditional);

/**
* @param data parameter value
* @since jQuery 1.8
*/
@Nonnull IMPLTYPE jQuery_parseHTML(@Nonnull String data);
...
* @since jQuery 1.8
*/
@Nonnull IMPLTYPE jQuery_parseHTML(@Nonnull String data, @Nonnull EHTMLElement context);
...
* @since jQuery 1.8
*/
@Nonnull IMPLTYPE jQuery_parseHTML(@Nonnull String data, @Nonnull String context);

/**
* @param data parameter value
* @param context parameter value
* @param keepScripts parameter value
* @since jQuery 1.8
*/
@Nonnull IMPLTYPE jQuery_parseHTML(@Nonnull String data, @Nonnull EHTMLElement context, boolean keepScripts);
...
* @since jQuery 1.8
*/
@Nonnull IMPLTYPE jQuery_parseHTML(@Nonnull String data, @Nonnull String context, boolean keepScripts);

/**
* @param json parameter value
* @since jQuery 1.4.1
*/
@Nonnull IMPLTYPE jQuery_parseJSON(@Nonnull String json);

/**
* @param data parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_parseXML(@Nonnull String data);

/**
* @param url parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url);

/**
* @param url parameter value
* @param data parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull IJSExpression data);

/**
* @param url parameter value
* @param data parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull String data);
...
* @param success parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull IJSExpression data, @Nonnull JSAnonymousFunction success);
...
* @param success parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull String data, @Nonnull JSAnonymousFunction success);
...
* @param dataType parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull IJSExpression data, @Nonnull JSAnonymousFunction success, @Nonnull String dataType);
...
* @param dataType parameter value
*/
@Nonnull IMPLTYPE jQuery_post(@Nonnull String url, @Nonnull String data, @Nonnull JSAnonymousFunction success, @Nonnull String dataType);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_proxy(@Nonnull JSAnonymousFunction function, @Nonnull IJSExpression context);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE jQuery_proxy(@Nonnull IJSExpression context, @Nonnull String name);

/**
* @param function parameter value
* @param context parameter value
* @param additionalArguments parameter value
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE jQuery_proxy(@Nonnull JSAnonymousFunction function, @Nonnull IJSExpression context, @Nonnull IJSExpression additionalArguments);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE jQuery_proxy(@Nonnull IJSExpression context, @Nonnull String name, @Nonnull IJSExpression additionalArguments);

/**
* @param element parameter value
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull EHTMLElement element);

/**
* @param element parameter value
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull String element);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull EHTMLElement element, @Nonnull String queueName);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull String element, @Nonnull String queueName);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull EHTMLElement element, @Nonnull String queueName, @Nonnull JSArray newQueue);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull String element, @Nonnull String queueName, @Nonnull JSArray newQueue);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull EHTMLElement element, @Nonnull String queueName, @Nonnull JSAnonymousFunction callback);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE jQuery_queue(@Nonnull String element, @Nonnull String queueName, @Nonnull JSAnonymousFunction callback);

/**
* @param element parameter value
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_removeData(@Nonnull EHTMLElement element);

/**
* @param element parameter value
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_removeData(@Nonnull String element);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_removeData(@Nonnull EHTMLElement element, @Nonnull String name);
...
* @since jQuery 1.2.3
*/
@Nonnull IMPLTYPE jQuery_removeData(@Nonnull String element, @Nonnull String name);

@Deprecated
@Nonnull IMPLTYPE jQuery_sub();

/**
* @param str parameter value
*/
@Nonnull IMPLTYPE jQuery_trim(@Nonnull String str);

/**
* @param obj parameter value
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE jQuery_type(@Nonnull IJSExpression obj);

/**
* @param array parameter value
* @since jQuery 1.1.3
*/
@Nonnull IMPLTYPE jQuery_unique(@Nonnull JSArray array);

/**
* @param deferreds parameter value
* @since jQuery 1.5
*/
@Nonnull IMPLTYPE jQuery_when(@Nonnull IJSExpression deferreds);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE keydown(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE keypress(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE keyup(@Nonnull IJSExpression eventData);
...
*/
@Deprecated
@Nonnull IMPLTYPE load(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mousedown(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mouseenter(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mouseleave(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mousemove(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mouseout(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mouseover(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE mouseup(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE nextUntil(@Nonnull EHTMLElement element);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE nextUntil(@Nonnull EHTMLElement element, @Nonnull IJQuerySelector filter);
...
* @since jQuery 1.4
*/
@Nonnull IMPLTYPE _not(@Nonnull IJSExpression jQuery_object);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE parentsUntil(@Nonnull EHTMLElement element);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE parentsUntil(@Nonnull EHTMLElement element, @Nonnull IJQuerySelector filter);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE prevUntil(@Nonnull EHTMLElement element);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE prevUntil(@Nonnull EHTMLElement element, @Nonnull IJQuerySelector filter);
...
* @since jQuery 1.6
*/
@Nonnull IMPLTYPE prop(@Nonnull IJSExpression properties);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE resize(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE scroll(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE select(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE submit(@Nonnull IJSExpression eventData);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE trigger(@Nonnull IJSExpression event);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE trigger(@Nonnull IJSExpression event, @Nonnull JSArray extraParameters);
...
* @since jQuery 1.3
*/
@Nonnull IMPLTYPE trigger(@Nonnull IJSExpression event, @Nonnull IJSExpression extraParameters);
...
* @param event parameter value
*/
@Nonnull IMPLTYPE unbind(@Nonnull IJSExpression event);
...
* @since jQuery 1.4.3
*/
@Nonnull IMPLTYPE undelegate(@Nonnull String selector, @Nonnull IJSExpression events);
...
*/
@Deprecated
@Nonnull IMPLTYPE unload(@Nonnull IJSExpression eventData);
